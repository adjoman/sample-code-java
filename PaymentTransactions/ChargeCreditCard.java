...
public class ChargeCreditCard {
	...
	public static void main(String apiLoginId, String transactionKey) {
		System.out.println("Charge Credit Card Sample");
		
		//Common code to set for all requests -- set the environment
        ...
        txnRequest.setAmount(new BigDecimal(500.00));	// set the amount of your transaction
